...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'new_infos_retry_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            # ann_file='new_infos_retry_infos_train.pkl',
            # ann_file='debug_infos_train_with_2d.pkl',
            ann_file='nuscenes_infos_train_with_2d.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        # ann_file='new_infos_retry_infos_val.pkl',
        # ann_file='debug_infos_val_with_2d.pkl',
        ann_file='nuscenes_infos_val_with_2d.pkl',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file='new_infos_retry_infos_val.pkl',
        # ann_file='debug_infos_val_with_2d.pkl',
        ann_file='nuscenes_infos_test_with_2d.pkl',
        pipeline=test_pipeline,
        metainfo=metainfo,
        modality=input_modality,
        data_prefix=data_prefix,
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'nuscenes_infos_val_with_2d.pkl',
    metric='bbox',
    backend_args=backend_args)
