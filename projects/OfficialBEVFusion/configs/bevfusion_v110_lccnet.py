...
custom_imports = dict(
    imports=['projects.OfficialBEVFusion.bevfusion'], allow_failed_imports=False)
...
model = dict(
    ...
    # ==========================================================
    # O-5: LCCNet calibration baseline
    # ==========================================================
    calibration_mode='lccnet',

    # ----------------------------------------------------------
    # EXACT SAME perturbation condition as Official O-3 Broken
    # ----------------------------------------------------------
    ...
    lccnet_checkpoint=(
        'data/work_dirs/'
        'lccnet_nuscenes_v110_256x704_f2_ddp2_full/'
        'best_joint_model.pth'
    ),

    # IMPORTANT:
    # Ignore "f2" in work-dir name.
    # Actual checkpoint metadata says use_feat_from=1.
    lccnet_use_feat_from=1,

    lccnet_depth_scale=50.0,

    # One nuScenes frame = 6 cameras
    lccnet_cam_chunk=6,
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='v110_infos/nuscenes_infos_val.pkl',
...
val_evaluator = dict(
    type='NuScenesMetric',
    data_root=data_root,
    ann_file=data_root + 'v110_infos/nuscenes_infos_val.pkl',
    metric='bbox',
    backend_args=backend_args)
